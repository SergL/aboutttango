...
(function(){
	...
	var html_form = '<div id="bonus-form">\
				<p class="popup_submit_wrap"><span class="wpp_helper_box"><a onclick="open_win(\'http://www.youtube.com/watch?v=_eEixBWq_6U&list=PLI8Gq0WzVWvJ60avoe8rMyfoV5qZr3Atm&index=8\')">Видео урок</a></span><input type="button" id="bonus_submit" class="button-primary" value="Вставить" name="submit" /></p>\

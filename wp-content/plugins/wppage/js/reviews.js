...
(function(){
	...
	var html_form = '<div id="review-form">\
				<p class="popup_submit_wrap"><span class="wpp_helper_box"><a onclick="open_win(\'http://www.youtube.com/watch?v=YNJDDMk2cwA&list=PLI8Gq0WzVWvJ60avoe8rMyfoV5qZr3Atm&index=12\')">Видео урок</a></span><input type="button" id="review_submit" class="button-primary" value="Вставить" name="submit" /></p>\

...
(function(){
	...
	var html_form = '<div id="googleform-form">\
					<p class="popup_submit_wrap"><span class="wpp_helper_box"><a onclick="open_win(\'http://www.youtube.com/watch?v=-XCJhRmLz2A&list=PLI8Gq0WzVWvJ60avoe8rMyfoV5qZr3Atm&index=4\')">Видео урок</a></span><input type="button" id="googleform-submit" class="button-primary" value="Вставить форму" name="submit" /></p>\
		...
		createControl : function(id, controlManager) {
			if (id == 'googleform_button') {
				...
				var button = controlManager.createButton('googleform_button', {
					...
					image : plugin_url+'/wppage/i/forms.png',  // path to the button's image
					onclick : function() {

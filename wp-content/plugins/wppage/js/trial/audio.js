...
(function(){
	...
	var html_form = '<div id="audio-form">\
					<p class="popup_submit_wrap"><span class="wpp_helper_box"><a class="" target="_blank" href="http://wppage.ru/wppage_lessons/Audio.mp4">Видео урок</a></span><input type="button" id="audiolink-submit" class="button-primary" value="Вставить аудио" name="submit" /></p>\

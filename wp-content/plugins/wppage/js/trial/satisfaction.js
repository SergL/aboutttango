...
(function(){
	...
	var html_form = '<div id="satisfaction-form">\
				<p class="popup_submit_wrap"><span class="wpp_helper_box"><a class="" target="_blank" href="http://wppage.ru/wppage_lessons/garantee.mp4">Видео урок</a></span><input type="button" id="satisfaction_submit" class="button-primary" value="Вставить" name="submit" /></p>\

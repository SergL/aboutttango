...
(function(){
	...
	<label><input type="text" id="c-minutes" name="c-minutes" /> Минуты </label><br><br>\
					...
					<div class="wpp_helper_box"><a class="" target="_blank" href="http://wppage.ru/wppage_lessons/Timer.mp4">Видео урок</a></div>\
					</div>\
					</div>';
		...
		createControl : function(id, controlManager) {
			if (id == 'countdown_button') {
				...
				var button = controlManager.createButton('countdown_button', {
					...
					image : plugin_url+'/wppage/i/trial/countdown.png',  // path to the button's image
					onclick : function() {
	...
	jQuery(function(){
		...
		form.find('#countdown-submit').click(function(){
            ...
            var counter_image = '';
            if(c_image) {
               counter_image = '<img src="'+ plugin_url +'/wppage/i/timer/'+ c_image +'.png"><br>';
            }

...
(function(){
	...
	var html_form = '<div id="audio-form">\
					...
					<div class="wpp_helper_box"><a class="" target="_blank" href="http://wppage.ru/wppage_lessons/Audio.mp4">Видео урок</a></div>\
					</div>\
					</div>';
		...
		createControl : function(id, controlManager) {
			if (id == 'audio_button') {
				...
				var button = controlManager.createButton('audio_button', {
					...
					image : plugin_url+'/wppage/i/trial/audio.png',  // path to the button's image
					onclick : function() {

...
(function(){
		...
		createControl : function(id, controlManager) {
			if (id == 'satisfaction_button') {
				...
				var button = controlManager.createButton('satisfaction_button', {
					...
					image : plugin_url+'/wppage/i/trial/satisfaction.png',  // path to the button's image
					onclick : function() {
	...
	jQuery(function(){
		...
		form.find('#satisfaction_submit').click(function(){
			...
			var shortcode = '<p><img class="aligncenter ps_satisfaction" src="'+plugin_url+'/wppage/i/satisfaction/'+satisfaction+'.png" alt="" /></p>';

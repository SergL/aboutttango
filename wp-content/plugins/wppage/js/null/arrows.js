...
(function(){
		...
		createControl : function(id, controlManager) {
			if (id == 'arrows_button') {
				...
				var button = controlManager.createButton('arrows_button', {
					...
					image : plugin_url+'/wppage/i/trial/arrows.png',  // path to the button's image
					onclick : function() {
	...
	jQuery(function(){
		...
		form.find('#arrows_submit').click(function(){
			...
			var shortcode = '<p class="aligncenter"><img class="aligncenter ps_arrow" src="'+plugin_url+'/wppage/i/arrows/'+arrow_name+extention+'" alt="" /></p>';

...
(function(){
    ...
    var html_form = '<div id="divider-form">\
				<p class="popup_submit_wrap"><span class="wpp_helper_box"><a class="" target="_blank" href="http://wppage.ru/wppage_lessons/separator.mp4">Видео урок</a></span><input type="button" id="divider_submit" class="button-primary" value="Вставить" name="submit" /></p>\
        ...
        <table class="table_preview"><tr><td class="wpp_divide_first" style="width: 65px">текст<br>&nbsp;<br>&nbsp;<br>&nbsp;</td><td class="wpp_divide_second" style="width: 35px">текст<br>&nbsp;<br>&nbsp;</td></tr></table>\

...
(function(){
	...
	var html_form = '<div id="bullets-form">\
				<p class="popup_submit_wrap"><span class="wpp_helper_box"><a onclick="open_win(\'http://www.youtube.com/watch?v=vEPf5_ltmnQ&list=PLI8Gq0WzVWvJ60avoe8rMyfoV5qZr3Atm&index=7\')">Видео урок</a></span><input type="button" id="bullets_submit" class="button-primary" value="Вставить" name="submit" /></p>\
		...
		createControl : function(id, controlManager) {
			if (id == 'bullets_button') {
				...
				var button = controlManager.createButton('bullets_button', {
					...
					image : plugin_url+'/wppage/i/bullet.png',  // path to the button's image
					onclick : function() {

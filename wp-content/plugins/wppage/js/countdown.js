...
(function(){
	...
	var html_form = '<div id="countdown-form">\
					<p class="popup_submit_wrap"><span class="wpp_helper_box"><a onclick="open_win(\'http://www.youtube.com/watch?v=u0eBt5cj7m0&list=PLI8Gq0WzVWvJ60avoe8rMyfoV5qZr3Atm&index=14\')">Видео урок</a></span><input type="button" id="countdown-submit" class="button-primary" value="Вставить таймер" name="submit" /></p>\

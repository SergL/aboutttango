...
(function(){
	...
	var html_form = '<div id="header-form">\
				<p class="popup_submit_wrap"><span class="wpp_helper_box"><a onclick="open_win(\'http://www.youtube.com/watch?v=zIzUMUOJzug&list=PLI8Gq0WzVWvJ60avoe8rMyfoV5qZr3Atm&index=13\')">Видео урок</a></span><input type="button" id="header_submit" class="button-primary" value="Вставить" name="submit" /></p>\
		...
		createControl : function(id, controlManager) {
			if (id == 'header_button') {
				...
				var button = controlManager.createButton('header_button', {
					...
					image : plugin_url+'/wppage/i/header.png',  // path to the button's image
					onclick : function() {

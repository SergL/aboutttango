...
(function(){
	...
	var html_form = '<div id="video-form">\
					<p class="popup_submit_wrap"><span class="wpp_helper_box"><a onclick="open_win(\'http://www.youtube.com/watch?v=HybuTJ7oqrQ&list=PLI8Gq0WzVWvJ60avoe8rMyfoV5qZr3Atm&index=3\')">Видео урок</a></span><input type="button" id="videolink-submit" class="button-primary" value="Вставить видео" name="submit" /></p>\
		...
		createControl : function(id, controlManager) {
			if (id == 'video_button') {
				...
				var button = controlManager.createButton('video_button', {
					...
					image : plugin_url+'/wppage/i/video.png',  // path to the button's image
					onclick : function() {
